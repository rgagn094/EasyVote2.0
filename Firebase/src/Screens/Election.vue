...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.$http.get(`https://easyvote-f20bf.firebaseapp.com/election/view/${this.electionID}`).then((response)=>{
        ...
        methods:{
            fetchAnalytics() {
                this.$http.get(`https://easyvote-f20bf.firebaseapp.com/analytics/${this.electionID}/province`).then(
                    (response)=>{
